 ...
 */
public class XaPrepareTransactionCommand extends AbstractCommand implements XaCommand {
    private static final byte[] PREFIX = {0x0A, 0x0C};

    private final Xid xid;

    public XaPrepareTransactionCommand(SequenceNumber sequenceNumber, Xid xid) {
