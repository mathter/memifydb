 ...
 */
public class XaWrapperCommand<C extends Command> extends AbstractCommand implements XaCommand {
    ...
    public XaWrapperCommand(SequenceNumber sequenceNumber, Xid xid, C command) {
