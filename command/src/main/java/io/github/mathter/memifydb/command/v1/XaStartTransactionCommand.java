 ...
 */
public class XaStartTransactionCommand extends AbstractCommand implements XaCommand {
    ...
    public XaStartTransactionCommand(SequenceNumber sequenceNumber, Xid xid, int flags) {
