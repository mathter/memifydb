 ...
 */
public class XaRollbackTransactionCommand extends AbstractCommand implements XaCommand {
    private static final byte[] PREFIX = {0x0A, 0x0E};

    private final Xid xid;

    public XaRollbackTransactionCommand(SequenceNumber sequenceNumber, Xid xid) {
