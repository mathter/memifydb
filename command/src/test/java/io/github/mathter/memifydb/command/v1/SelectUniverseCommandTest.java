...
public class SelectUniverseCommandTest extends AbstractCommadTest {
    @Test
    public void test() throws IOException {
        final ByteArrayOutputStream baos = new ByteArrayOutputStream();
        final SequenceNumber sequenceNumber = new SequenceNumber(RandomUtils.nextInt());
        final SelectUniverseCommand command = new SelectUniverseCommand(
                sequenceNumber,
        ...
        final SelectUniverseCommand deserializedCommand = this.deserializer.deserialize(bais);
        Assertions.assertNotNull(deserializedCommand);
        Assertions.assertEquals(sequenceNumber, deserializedCommand.getSequenceNumber());
        Assertions.assertEquals(command.getUniverseName(), deserializedCommand.getUniverseName());
    }
}
